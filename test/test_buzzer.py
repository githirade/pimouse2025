...
from pimouse_2025.msg import MusicAction, MusicResult, MusicFeedback, MusicGoal
...
class BuzzerTest(unittest.TestCase):
    ...
    def test_music(self):
        ...
        self.assertEqual(goal.freqs,self.device_valies,"invalid feedback" + ",".join([str(e) for e in self.device_values]))
...
if __name__ == '__main__':
    ...
    rostest.rosrun('pimouse_2025','test_buzzer',BuzzerTest)
